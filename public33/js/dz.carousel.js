...
var CawCartCarousel = function(){
	...
	var ProductGallerySwiper1 = function() {	
		...
		// Swiper Four ==
		var handleSwiperFourSLIDER = function() {	
			if(jQuery('.swiper-fourSLIDER').length > 0){
				var swiper = new Swiper( '.swiper-fourSLIDER', {
					slidesPerView: 'auto',
					spaceBetween: 10,
					loop: false,
					autoplay: {
